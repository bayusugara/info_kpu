...
<body>
<div class="container-fluid" style="padding-left: 100px; background-image: url('<?= base_url('libraries/frontend/') ?>images/headbg.jpg'); size: 100%;">
    <div class="container" >
        <div class="row">
            ...
            <div class="col-12 col-md-6 align-self-center fh5co_mediya_left" style="text-align: center;">
                ...
                <h1 style="color:#2c2b27;"><b>KOMISI PEMILIHAN UMUM</b></h1>
                <h1 style="color: #2c2b27;"><b>KOTA PEKANBARU</b></h1>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Informasi Umum (Calon Pilkada)</div>
                </div>
                <!--Fetch data dari database-->
                <div class="row">
                <?php foreach ($data->result() as $cp) {?>
                
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="text-center">
								<h3 class="text-dark"><b data-plugin="counterup"><?php echo $cp->nama_calon; ?></b></h3>
								<p class="text-muted"><?php echo $cp->gender; ?></p>
								<p class="text-muted"><?php echo $cp->tgl_lahir; ?> </p>
								<p class="text-muted"><?php echo $cp->alamat; ?></p>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
                ...
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Informasi Umum (Pasangan Calon Pilkada)</div>
                    <!--Fetch data dari database-->
                <div class="row">
                <?php foreach ($paslon as $ps) {?>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="widget-bg-color-icon card-box">
                            <div class="text-center">
                                <h3 class="text-dark"><b data-plugin="counterup"><?php echo $ps->jenis_pemilihan; ?></b></h3>
                                <p class="text-muted">Nomor urut: <?php echo $ps->nomor_urut; ?></p>
                                <p class="text-muted">Nama Kepala Daerah: <?php echo $ps->id_kepala_daerah; ?></p>
                                <p class="text-muted">Nama Wakil Kepala Daerah: <?php echo $ps->id_wakil_kepala_daerah; ?></p>
                                <p class="text-muted">Tahun: <?php echo $ps->tahun; ?></p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="fh5co_tags_all">
                    <a href="<?= site_url('InformasiUmumPilkada') ?>" class="fh5co_tagg">Informasi Umum Pilkada</a>
                    <a href="<?= site_url('InformasiUmumPileg') ?>" class="fh5co_tagg">Informasi Umum Pileg</a>
                    <a href="<?= site_url('InformasiUmumPilpres') ?>" class="fh5co_tagg">Informasi Umum Pilpres</a>
                </div>
