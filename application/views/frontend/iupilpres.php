    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Informasi Umum (Calon Pilpres)</div>
                </div>
                ...
                <div>
                <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Informasi Umum (Pasangan Calon Pilpres)</div>
                    <!--Fetch data dari database-->
                    <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="widget-bg-color-icon card-box">
                            <div class="text-center">
                                <h3 class="text-dark"><b data-plugin="counterup">Pemilihan Presiden</b></h3>
                                <p class="text-muted">Nomor urut: <?php echo $ps->nomor_urut; ?></p>
                                <p class="text-muted">Nama Calon Presiden: <?php echo $ps->id_capres; ?></p>
                                <p class="text-muted">Nama Calon Wakil Presiden: <?php echo $ps->id_cawapres; ?></p>
