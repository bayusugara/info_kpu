    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row">
                <?php $no = 1; foreach ($data as $cp) {?>
                
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="widget-bg-color-icon card-box">
                            <div class="text-center">
                                <h3 class="text-dark"><b data-plugin="counterup">PEKANBARU KOTA</b></h3>
                                <p class="text-muted">Partai : <?php echo $cp->nama_parpol; ?></p>
                                <p class="text-muted">Suara Partai : <?php echo $cp->jumlah_suara; ?></p>
                                    <p class="text-muted">Calon Legislatif :</p>
                                <?php foreach ($pileg as $pg){ ?>
                                <?php if ($pg->id_parpol == $cp->id_parpol) { ?>
                                    - <?php echo $pg->nama_calon; ?><br>
                                <?php } ?>
