    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Informasi Umum (Calon Pileg)</div>
                </div>
					...
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="text-center">
								<a href="<?= site_url('InformasiUmumPileg/detail/'.$cp->id_calon_pileg); ?>"><h3 class="text-dark"><b data-plugin="counterup"><?php echo $cp->nama_calon; ?></b></h3></a>
