    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Data KPU</div>
                </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="widget-bg-color-icon card-box">
                            <div class="text-center">
                                <h3 class="text-dark"><b data-plugin="counterup"><?php echo $k->nama_kecamatan; ?></b></h3>
                                <?php foreach ($data as $cp) { ?>
                                   <?php if ($cp->id_kecamatan == $k->id_kecamatan) { ?>
                                        <p class="text-muted">Capres :<br><?php echo $cp->id_capres; ?></p>
                                        <p class="text-muted">Cawapres :<br><?php echo $cp->id_cawapres; ?></p>
                                        <p class="text-muted">Jumlah Suara : <?php echo $cp->jumlah_suara; ?></p>
                                        <p class="text-muted">Periode : <?php echo $cp->tahun; ?> - <?php echo $cp->tahun+5; ?></p><hr>
                                   <?php  } ?>
                               <?php } ?>
                            </div>
                            <div class="clearfix"></div>
