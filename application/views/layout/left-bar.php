    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect <?= isset($main_menu)&&$main_menu=='Data Pemilu' ? 'subdrop' : '' ?>"><i class="ti-pin2"></i> <span> Data Pemilu </span> <span class="menu-arrow"></span> </a>
                    <ul class="list-unstyled" style="<?= isset($main_menu)&&$main_menu=='Data Pemilu' ? 'display:block' : '' ?>">
                        ...
                        <li class="has_sub">
                            ...
                            <ul style="<?= isset($sub_menu) && $sub_menu == 'PILPRES' ? 'display:block' : '' ?>">
                                ...
                                <li class="<?= isset($detail_menu) && $detail_menu == 'Suara Calon Pilpres' ? 'active' : '' ?>"><a href="<?= site_url('SuaraCalonPilpres') ?>"><span>Data Perolehan Suara</span></a></li>
                            </ul>
                        </li>
                        <!-- Jadwal Kampanye -->
                        <!--
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect <?= isset($main_menu)&&$main_menu=='Data Wilayah' ? 'subdrop' : '' ?>"><i class="ti-location-pin"></i> <span> Data Wilayah </span> <span class="menu-arrow"></span> </a>
                ...
                <li>
                    <a href="<?= site_url('Parpol') ?>" class="waves-effect <?= isset($main_menu)&&$main_menu=='Parpol' ? 'active' : '' ?>"><i class="ti-flag"></i> <span> Parpol </span> </a>
                </li>
                <li>
